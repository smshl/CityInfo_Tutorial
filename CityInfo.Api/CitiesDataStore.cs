        ...
        public CitiesDataStore()
        {
            Cities = new List<CityDto>()
            {
                ...
                new CityDto(){Id = 1,Name = "Tehran" , Description = "The Jerusalem",PointsOfView = new List<PointOfViewDto>{
                    new PointOfViewDto { Id = 0,Name = "Azadi Square" , Description = "West of Tehran" },
                    new PointOfViewDto { Id = 1,Name = "Andarzgoo" , Description = "Lovely street to drive" },
                    new PointOfViewDto { Id = 2,Name = "Students Park" , Description = "Rainbow people" },
                }
                },
